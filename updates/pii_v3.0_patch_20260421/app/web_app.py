...
_LOG_EXTENSIONS = {'.log', '.txt', '.gz', '.audit', '.json', '.csv',
                   '.docx', '.pdf', '.xlsx', '.xls', '.xlsm', '.pptx', '.ppt', '.xml'}
    ...
    <div class="card-body">
      ...
      <div class="mb-3">
        ...
        <div class="drop-zone" id="dropZone">
          ...
          <div class="small text-muted mt-1">.log, .txt, .gz, .zip, .docx, .pdf, .xlsx, .pptx 등 다중 선택 가능</div>
          <input type="file" id="fileInput" multiple accept=".log,.gz,.txt,.audit,.json,.zip,.tar,.tgz,.docx,.pdf,.xlsx,.xls,.xlsm,.pptx,.ppt,.xml"
                 style="display:none">
        </div>
              ...
              <div class="col-md-6">
                <div class="guide-step">
                  ...
                  <div class="mt-2 p-2 rounded small" style="background:#f0f4ff">
                    ...
                    <br><strong>문서 처리:</strong> Word(.docx) · PDF · Excel(.xlsx/.xls) · PowerPoint(.pptx) · XML — 텍스트 자동 추출 후 PII 탐지
